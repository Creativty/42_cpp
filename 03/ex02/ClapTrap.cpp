...
/*   Updated: 2025/01/01 10:51:33 by aindjare         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(): name("unnamed"), attack_damage(30), energy_points(100),
						hit_points(100) {
	std::cout << "ClapTrap :: constructor default" << std::endl;
}
ClapTrap::ClapTrap(std::string name):	name(name), attack_damage(30),
						energy_points(100), hit_points(100) {
